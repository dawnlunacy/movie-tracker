...
const Movie = ({ movie_id, title, poster_path, release_date, vote_average, overview, makeFavorite, currentUser }) => {
  console.log(movie_id, title, poster_path, release_date, vote_average, overview, makeFavorite, currentUser)
  ...
  return (
    <section className="grow">
      ...
      <img src={star} alt="Logo" className="movie-star" onClick={() => makeFavorite({
       movie_id: movie_id,
       title: title,
